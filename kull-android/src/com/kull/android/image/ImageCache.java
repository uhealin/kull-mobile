...
import com.kull.android.AppManager;
import com.kull.android.app.KULLApplication.OnLowMemoryListener;
...
public class ImageCache implements OnLowMemoryListener {
    ...
    public ImageCache(Context context) {
        ...
        AppManager.getApplication(context).registerOnLowMemoryListener(this);
    }

    public static ImageCache from(Context context) {
        return AppManager.getImageCache(context);
    }
