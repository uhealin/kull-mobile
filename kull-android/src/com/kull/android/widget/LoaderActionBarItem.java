...
public class LoaderActionBarItem extends NormalActionBarItem {
    ...
    protected View createItemView() {
        return LayoutInflater.from(mContext).inflate(RHelper.layout.kull_action_bar_item_loader, mActionBar, false);
    }

    @Override
    protected void prepareItemView() {
        super.prepareItemView();
        mButton = mItemView.findViewById(RHelper.id.kull_action_bar_item);
        mProgressBar = mItemView.findViewById(RHelper.id.kull_action_bar_item_progress_bar);
    }
