...
public class DrawableItem extends TextItem {
    ...
    public ItemView newView(Context context, ViewGroup parent) {
        return createCellFromXml(context, RHelper.layout.kull_drawable_item_view, parent);
    }
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs) throws XmlPullParserException, IOException {
        ...
        TypedArray a = r.obtainAttributes(attrs, RHelper.styleable.kull_DrawableItem);
        drawableId = a.getResourceId(RHelper.styleable.kull_DrawableItem_drawable, 0);
        a.recycle();
    }
