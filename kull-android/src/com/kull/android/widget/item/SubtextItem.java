...
public class SubtextItem extends TextItem {
    ...
    public ItemView newView(Context context, ViewGroup parent) {
        return createCellFromXml(context, RHelper.layout.kull_subtext_item_view, parent);
    }
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs) throws XmlPullParserException, IOException {
        ...
        TypedArray a = r.obtainAttributes(attrs, RHelper.styleable.kull_SubtextItem);
        subtext = a.getString(RHelper.styleable.kull_SubtextItem_subtext);
        a.recycle();
    }
