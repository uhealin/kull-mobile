 ...
 */
package com.kull.android.widget.item;
...
import com.kull.android.widget.itemview.ItemView;
...
public class ThumbnailItem extends SubtitleItem {
    ...
    public ItemView newView(Context context, ViewGroup parent) {
        return createCellFromXml(context, RHelper.layout.kull_thumbnail_item_view, parent);
    }
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs) throws XmlPullParserException, IOException {
        ...
        TypedArray a = r.obtainAttributes(attrs, RHelper.styleable.kull_ThumbnailItem);
        drawableId = a.getResourceId(RHelper.styleable.kull_ThumbnailItem_thumbnail, drawableId);
        drawableURL = a.getString(RHelper.styleable.kull_ThumbnailItem_thumbnailURL);
        a.recycle();
    }
