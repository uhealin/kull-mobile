...
public class ProgressItem extends TextItem {
    ...
    public ItemView newView(Context context, ViewGroup parent) {
        return createCellFromXml(context, RHelper.layout.kull_progress_item_view, parent);
    }
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs) throws XmlPullParserException, IOException {
        ...
        TypedArray a = r.obtainAttributes(attrs, RHelper.styleable.kull_ProgressItem);
        isInProgress = a.getBoolean(RHelper.styleable.kull_ProgressItem_isInProgress, DEFAULT_IS_IN_PROGRESS);
        a.recycle();
    }
