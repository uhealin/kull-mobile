...
public class SubtitleItem extends TextItem {
    ...
    public ItemView newView(Context context, ViewGroup parent) {
        return createCellFromXml(context, RHelper.layout.kull_subtitle_item_view, parent);
    }
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs) throws XmlPullParserException, IOException {
        ...
        TypedArray a = r.obtainAttributes(attrs, RHelper.styleable.kull_SubtitleItem);
        subtitle = a.getString(RHelper.styleable.kull_SubtitleItem_subtitle);
        a.recycle();
    }
}
