 ...
 */
package com.kull.android.graphics.drawable;
...
public class ActionBarDrawable extends BitmapDrawable {
    ...
    public ActionBarDrawable(Context context, Drawable d) {
        ...
        this(context, d, getColorFromTheme(context, RHelper.attr.kull_ActionBarItemColorNormal, Color.WHITE), getColorFromTheme(context,
                RHelper.attr.kull_ActionBarItemColorAlt, Color.BLACK));
    }
