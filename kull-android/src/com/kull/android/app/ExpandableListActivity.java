 ...
 * ExpandableListView.
 */
public class ExpandableListActivity extends BaseActivity implements OnCreateContextMenuListener, ExpandableListView.OnChildClickListener,
    ...
    public ExpandableListActivity(ActionBar.Type actionBarType) {
        super(actionBarType);
    }
    ...
    public int createLayout() {
        switch (getActionBarType()) {
            case Dashboard:
                return RHelper.layout.kull_expandable_list_content_dashboard;
            case Empty:
                return RHelper.layout.kull_expandable_list_content_empty;
            case Normal:
            default:
                return RHelper.layout.kull_expandable_list_content_normal;
        }
    }
